...
public class RegolithFilterScreen extends AbstractContainerScreen<RegolithFilterMenu>
{
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(MODID, "textures/gui/amethyst_filter_gui.png");

    public RegolithFilterScreen(RegolithFilterMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
